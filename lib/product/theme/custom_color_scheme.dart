import 'package:bluetoothpinterapp/product/constant/color.dart';
...
final class CustomColorScheme {
  ...
  static ColorScheme lightColorScheme = ColorScheme(
    ...
    primary: AppColorPalette.primaryColor, // one primary color hex to #5150FF
    ...
    onSecondary: const Color.fromARGB(155, 82, 99, 80),
    ...
    surface: const Color(0xFFCED4DA),
    ...
    inversePrimary: const Color.fromARGB(255, 82, 191, 102),
  );
}
